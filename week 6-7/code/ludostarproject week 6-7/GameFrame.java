...
public class GameFrame extends JFrame {
    ...
    public void refresh() {
        ...
        rollButton.setEnabled(!controller.isGameOver() && !choosing);
    ...
    private JPanel createRightPanel() {
        ...
        list.add(playerRow(PlayerColor.RED, "Player 1 (Red)"));
        list.add(playerRow(PlayerColor.GREEN, "Player 2 (Green)"));
        list.add(playerRow(PlayerColor.YELLOW, "Player 3 (Yellow)"));
        list.add(playerRow(PlayerColor.BLUE, "Player 4 (Blue)"));
        playersBox.add(list, BorderLayout.CENTER);
